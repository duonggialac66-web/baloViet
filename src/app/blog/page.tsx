...
export const metadata: Metadata = {
  title: "Blog – Balo Việt",
  description: "Tin tức, mẹo du lịch và phong cách sống từ Balo Việt.",
};
  ...
  return (
    <main className="min-h-screen pt-24 pb-16 bg-[#0B0D0E]">
      <div className="max-w-[1440px] mx-auto px-6 lg:px-10">
        ...
        <p className="text-[#6B6E72] text-lg mb-8">Trang blog đang được phát triển.</p>
